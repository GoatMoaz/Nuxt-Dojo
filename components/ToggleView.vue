<template>
  <div>
    <label
      ...
      style="display: flex"
      class="h-4 justify-center items-center pt-2"
    >
      <input type="checkbox" id="toggle" :checked="isDark" @click="toggle" />
      <svg
      ...
      >
        ...
        >
          ...
          <g filter="url(#cloud)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
            <path
              fill="#fff"
              transform="translate(-3470.47 -160.94)"
